...
Mientras que los grupos mantienen tendencias centrales similares, el segmento masculino presenta una mayor variabilidad y presencia de valores atípicos en edades superiores (50-60 años).

---

### 🏥 ESTADO CLINICO - Descripcion de la muestra
**Acceso al Dashboard:** [Ver Dashboard Interactivo](https://jotabusconi.shinyapps.io/mental_health-frecuencia-diagnosticos/)

La muestra presenta una alta prevalencia de trastornos de salud mental, con una concentración predominante de casos de **depresión (407)** y **ansiedad (341)**, que se posicionan como las condiciones más reportadas. 
