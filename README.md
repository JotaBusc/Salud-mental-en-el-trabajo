...
Esta investigación analiza la prevalencia y los determinantes de la salud mental —específicamente la **depresión**— en trabajadores tecnológicos, utilizando el dataset de **OSMI**. El objetivo es transformar datos crudos en *insights* accionables para una gestión de Recursos Humanos basada en evidencia.
